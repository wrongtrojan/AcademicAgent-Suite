-- ContextMap core schema (PostgreSQL 14+)
...
-- --- knowledge_entities (deterministic id via app: uuid5 namespace) ---
...
-- --- job tracking (optional idempotency) ---
